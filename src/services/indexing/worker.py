...
class IndexingWorker:
    ...
    def __init__(
        ...
        self.consumer_group = os.getenv(
            "KAFKA_CONSUMER_GROUP", "indexing-workers"
        )
    ...
    async def process_job(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            # 4. Dividir en chunks
            logger.info(f"Dividiendo en chunks (size={self.chunk_size}, overlap={self.chunk_overlap})...")
            ...
            logger.info(
                ...
                f"{len(chunks_text)} chunks indexados"
            )
